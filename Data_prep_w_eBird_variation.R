...
# calculate the weekly values for each cell
# estimate the mean of the weekly values
# estimate the SD of the weekly values, assuming 80% CI is approximately normal
# Estimate the CV
# if(use_uncertainty){
#   
#   breed_abundance_upper <- terra::crop(breed_abundance_upper, region_boundary_proj) |>
#     terra::mask(region_boundary_proj)
#   
#   breed_abundance_lower <- terra::crop(breed_abundance_lower, region_boundary_proj) |>
#     terra::mask(region_boundary_proj)
# }
